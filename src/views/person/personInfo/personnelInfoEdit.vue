<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['人员管理', '人员信息管理', '人员信息列表', '编辑人员信息']" />
...
import { personInfo, personUpdate, getLoginName } from '@/api/data/person';
    ...
    getInfo() {
      if (this.$route.query.id) {
        ...
        personInfo(this.$route.query.id).then((response) => {
          ...
          // this.getPostList(response.data.deptId); //加载时需要手动触发添加选项

          listPost({ pageNum: 1, pageSize: 999, deptId: response.data.deptId }).then((response) => {
