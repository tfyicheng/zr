  ...
  <div class="appo">
    <div class="appi">
      <div class="top" style="margin-bottom: 15px">
        ...
        <span> > </span>
        <span style="cursor: pointer" @click="commonFun.goTo('人员请假统计')">人员请假统计</span>
      </div>

      <div class="part1" style="height: 200px"><TopInfoView :type="30" /></div>

      <div class="part7">
        <div
          v-hasPermi="['person:apply:add1']"
          class="part7item"
          style="background: #409eff"
          @click="goRoute('添加请假申请')"
        >
          添加请假申请
        </div>
        <div
          v-hasPermi="['person:apply:listAskForLeave']"
          class="part7item"
          style="background: #fac06a"
          @click="goRoute('查找请假申请')"
        >
          查找请假申请
        </div>
        <div
      ...
      <div class="part6">
        <div class="part6item" style="height: 370px"><TableAll :type="54" /></div>
        <div class="part6item" style="height: 370px"><PieChart :type="3" /></div>
      </div>
      ...
      <!-- 1 -->
      <!-- <div class="part1" style="height: 200px"><TopInfoView :type="30" ref="TopInfoView" /></div> -->
      <!-- 1:1.5 -->
      <!-- <div class="part4">
        <div class="part4item" style="height: 370px"><BarChart :type="25" /></div>
        <div class="part4item" style="height: 370px"><LineChart :type="2" /></div>
      </div>
      <div class="part4">
        <div class="part4item" style="height: 370px"><PieChart :type="3" /></div>
        <div class="part4item" style="height: 370px"></div>
      </div> -->
    </div>
  </div>
</template>
...
export default {
  name: 'PersonLeaveIndex', //人员请假统计分析'/person-d/personLeaveCheck'
  components: {
    TopInfoView,
    BarChart,
    PieChart,
  ...
  methods: {
    goRoute(val) {
      switch (val) {
        case '添加请假申请':
          this.$router.push({ path: '/person-d/personLeaveAdd' });
          break;
        case '查找请假申请':
