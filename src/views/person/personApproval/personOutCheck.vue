<template class="app-container">
  <div class="main">
    ...
    <!-- <div class="p2">
      ...
      <el-button type="warning" @click="exportList" :disabled="tableData.length == 0">导出</el-button>
      ...
      >
        ...
        <el-table-column label="业务类型">
          <template slot-scope="scope">
            <dict-tag :flag="false" :options="dict.type.out_type" :value="scope.row.businessType" />
          </template>
        </el-table-column>
        ...
        <el-table-column fixed="right" label="操作" :show-overflow-tooltip="false">
          <template slot-scope="scope">
            <el-button
              v-hasPermi="['person:apply:query0']"
...
export default {
  ...
  methods: {
    ...
    getList(queryParam) {
      ...
      listApproveo(this.queryParams).then((response) => {
    ...
    //导出列表
    exportList() {
      userOutExportList(this.queryParams);
    },

    /** 搜索按钮操作 */
    handleQuery() {
      this.$router.push({ path: '/person-d/personApprovalCheck', query: null });
