        ...
        <div class="main">
          <div class="p1">
            ...
            <div class="p1item">
              <span>业 务 类 型</span>
              <span>
                <dict-tag :options="dict.type.leave_type" :value="form.businessType" />
              </span>
            </div>
...
<script>
import { approveInfot, personOutApprove } from '@/api/data/person';
export default {
  name: 'PersonLeaveHandle', //处理请假审批
  ...
  methods: {
    ...
    getInfo() {
      if (this.$route.query.id) {
        ...
        approveInfot(this.$route.query.id).then((response) => {
