<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['人员管理', '人员合同管理', '人员合同列表', '添加人员合同']" />
        <div class="main">
          <div class="p0">
            <el-form :model="form" :inline="true" ref="form" :rules="ruleData">
              ...
              <el-form-item label="用 人 部 门" prop="ChooseDept">
                <el-input
              ...
              <el-form-item label="乙 方" prop="ChooseUser">
                <el-input
  ...
  data() {
    return {
      ...
      ruleData: {
        ...
        ChooseUser: [{ required: true, message: '请选择乙方', trigger: 'change' }],
        phone: [
      ...
      Promise.all([this.validateForm('form')]).then((res) => {
        if (res) {
          this.$refs.FileChoose.asyncUpFile().then((res) => {
            if (res) {
              this.form.firstParty = this.$store.state.user.cdeptId;
              console.log(this.form);
              this.$modal.loading('正在提交，请稍候...');
              laborContAdd(this.form)
                .then((res) => {
                  console.log(res);
