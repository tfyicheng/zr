    ...
    <div class="appi">
      <div class="appc">
        ...
        <div class="main">
          ...
          <div class="p2">
            <el-button v-hasPermi="['person:apply:add0']" type="primary" @click="addC"
              >添加</el-button
            >
            <el-button
              v-hasPermi="['person:apply:export0']"
              type="warning"
              @click="exportList"
...
import { listOut, personOutRevoket, userOutExportList } from '@/api/data/person';
export default {
  name: 'PersonOutCheck', //查看人员外出信息
  ...
  methods: {
    ...
    handleCheck(row) {
      console.log(row);
      this.$router.push({ path: '/person-d/personOutInfo', query: { id: row.id } });
    },
