  ...
  <div class="appo">
    <div class="appi">
      <div class="top" style="margin-bottom: 15px">
        ...
        <span> > </span>
        <span style="cursor: pointer" @click="commonFun.goTo('人员外出统计')">人员外出统计</span>
      </div>

      <div class="part1" style="height: 200px"><TopInfoView :type="29" /></div>

      <div class="part7">
        <div
          v-hasPermi="['person:apply:add0']"
          class="part7item"
          style="background: #409eff"
          @click="goRoute('添加外出申请')"
        >
          添加外出申请
        </div>
        <div
          v-hasPermi="['person:apply:listOut']"
          class="part7item"
          style="background: #fac06a"
          @click="goRoute('查找外出申请')"
        >
          查找外出申请
        </div>
        <div
      ...
      <div class="part6">
        <div class="part6item" style="height: 370px"><TableAll :type="53" /></div>
        <div class="part6item" style="height: 370px"><PieChart :type="2" /></div>
      </div>
      ...
      <!-- 1 -->
      <!-- <div class="part1" style="height: 200px"><TopInfoView :type="29" ref="TopInfoView" /></div> -->
      <!-- 1:1.5 -->
      <!-- <div class="part4">
      ...
      <div class="part4">
        <div class="part4item" style="height: 370px"><PieChart :type="2" /></div>
...
export default {
  name: 'PersonOutIndex', //人员外出统计分析'/person-d/personOutCheck'
  components: {
    TopInfoView,
    BarChart,
    PieChart,
  ...
  methods: {
    goRoute(val) {
      switch (val) {
        case '添加外出申请':
          this.$router.push({ path: '/person-d/personOutAdd' });
          break;
        case '查找外出申请':
