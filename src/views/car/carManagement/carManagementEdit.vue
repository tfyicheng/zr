<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['车辆管理', '车辆统计', '车辆列表', '编辑车辆']" />
        <div class="main">
          <div class="p0">
          ...
          <div class="p2">
            <div class="p2item">
              <span>车 辆 照 片</span>
              <!-- <FileUpload ref="uList" :value="form.carPicFile" /> -->
              <FileChoose
                ref="FileChoose"
...
<script>
import { carUpdate, carInfo } from '@/api/data/car';

export default {
  name: 'CarManagementEdit', //编辑车辆
  data() {
    return {
      form: {},
      flagId: null,
    ...
    getInfo() {
      if (this.$route.query.id) {
        ...
        carInfo(this.$route.query.id).then((response) => {
          ...
          this.form.annexFile = response.data.carPicFile;
        });
      }
    },
