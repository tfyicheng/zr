    ...
    <div class="appi">
      <div class="appc">
        ...
        <div class="main">
          ...
          <div class="p2">
            <el-button v-hasPermi="['car:car:applyCar']" type="primary" @click="addC"
              >添加</el-button
            >
            <el-button
              v-hasPermi="['property:applyCar:export']"
              type="warning"
              @click="exportList"
          ...
          <div class="p3">
            ...
            >
              ...
              <el-table-column prop="applyUser" label="用车人员"> </el-table-column>
...
import { carApplyList, carApplyCancel, carUse, carAppExportList } from '@/api/data/car';
export default {
  name: 'CarRequestCheck', //查看用车申请
  ...
  methods: {
    ...
    getList() {
      ...
      carApplyList(this.queryParams).then((response) => {
    ...
    //导出列表
    exportList() {
      carAppExportList(this.queryParams);
    },
    ...
    handleWork(row, handle) {
      ...
      if (handle.status == 5) {
        //归还
        this.$router.push({ path: '/car-d/carRequestReback', query: { id: row.id } });
      }
    },
    ...
    //编辑
    handleEdit(row) {
      this.$router.push({ path: '/car-d/carRequestEdit', query: { id: row.id } });
    },
