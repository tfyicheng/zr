  ...
  <el-dialog :visible.sync="visible" width="800px" top="5vh" append-to-body>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column label="名称" prop="userName" :show-overflow-tooltip="true" />
...
<script>
import { unallocatedUserList, authUserSelectAll } from '@/api/system/post';
export default {
  ...
  methods: {
    ...
    handleSelectUser() {
      ...
      authUserSelectAll({ userIds: userIds, postId: postId }).then((res) => {
