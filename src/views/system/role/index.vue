      ...
      <div class="appi">
        <div class="appc">
          ...
          <div class="main">
            ...
            <!-- 分配角色数据权限对话框 :title="title"-->
            <el-dialog :visible.sync="openDataScope" width="500px" append-to-body>
              <span class="dialogt">{{ title }}</span>

              <el-form :model="form" label-width="80px">
                <el-form-item label="角色名称">
                  <el-input v-model="form.roleName" :disabled="true" @input="$forceUpdate()" />
                </el-form-item>
                <el-form-item label="权限字符">
                  <el-input v-model="form.roleKey" :disabled="true" @input="$forceUpdate()" />
                </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        roleSort: [{ required: true, message: '角色顺序不能为空', trigger: ['blur', 'change'] }],
      },
    };
  },
  created() {
