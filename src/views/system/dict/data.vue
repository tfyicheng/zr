            ...
            <el-dialog :visible.sync="open" width="500px" append-to-body>
              ...
              <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="字典类型">
                  <el-input v-model="form.dictType" :disabled="true" @input="$forceUpdate()" />
                </el-form-item>
                ...
                <el-form-item label="数据键值" prop="dictValue">
                  <el-input
                    ...
                    placeholder="请输入数据键值"
                    @blur="(e) => (form.dictValue = e.target.value)"
                    @input="$forceUpdate()"
                    oninput="value=value.replace(/[^\d]/g,'')"
                    :disabled="this.title == '修改字典数据'"
                  />
                </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        dictSort: [{ required: true, message: '数据顺序不能为空', trigger: ['blur', 'change'] }],
      },
    };
  },
  created() {
  ...
  methods: {
    ...
    handleAdd(_data) {
      ...
      //添加子项
      if (_data.dictCode) {
        this.form.dictType = undefined;
        this.form.parentCode = _data.dictCode;
      }
