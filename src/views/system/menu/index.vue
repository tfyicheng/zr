        ...
        <div class="appc">
          ...
          <div class="main">
            ...
            <el-row :gutter="10" class="mb8">
              ...
              <el-col :span="1.5">
                <el-button type="info" size="mini" @click="toggleExpandAll">展开/折叠</el-button>
              </el-col>
            ...
            <!-- 添加或修改菜单对话框 :title="title"-->
            <el-dialog :visible.sync="open" width="680px" append-to-body>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        orderNum: [{ required: true, message: '菜单顺序不能为空', trigger: ['blur', 'change'] }],
