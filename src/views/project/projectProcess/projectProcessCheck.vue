            ...
            >
              ...
              <el-table-column fixed="right" label="操作" width="150">
                <template slot-scope="scope">
                  ...
                  > -->
                  <el-button
                    v-show="scope.row.children == null && scope.row.canReport"
                    type="text"
                    size="small"
...
<script>
import { projProgressList } from '@/api/data/project';
export default {
  name: 'ProjectProcessCheck', //查看项目进度
  ...
  methods: {
    //查询列表
    getList() {
      if (this.$route.query.showPrjNumber != null) {
        this.queryParams.prjNumber = this.$route.query.showPrjNumber;
        this.$router.push({ path: this.$router.currentRoute.path, query: null }); //重置路由参数
      }
      ...
      projProgressList(this.queryParams).then((response) => {
