<template class="app-container">
  <div class="main">
    <div class="mt">
      <el-button round :type="flag == 0 ? 'primary' : null" @click="tolish">收款节点</el-button>
      <el-button round :type="flag == 1 ? 'primary' : null" @click="tohis">开票记录</el-button>
      <el-button round :type="flag == 2 ? 'primary' : null" @click="tohis2">收款记录</el-button>
    </div>
    <div class="mb">
      <div v-show="flag == 0">
        <div class="tmain">
      ...
      <div v-show="flag == 1">
        <div class="tmain">
          <div class="top">
            <el-button
              v-hasPermi="['produce:invoice0:add']"
              type="primary"
              @click="addC2"
              icon="el-icon-plus"
            >
      ...
      <div v-show="flag == 2">
        <div class="tmain">
          <div class="top">
            <el-button
              v-hasPermi="['produce:payment1:add']"
              type="primary"
              @click="addC3"
              icon="el-icon-plus"
            >
          ...
          <div class="body">
            ...
            >
              ...
              <el-table-column prop="contName" label="合同名称"> </el-table-column>
              <!-- <el-table-column prop="prjName" label="项目名称"> </el-table-column> -->
              <el-table-column prop="handledBy" label="经办人"> </el-table-column>
              <!-- <el-table-column prop="nodeName" label="节点名称"> </el-table-column> -->
              <el-table-column prop="period" label="期次"> </el-table-column>
...
export default {
  ...
  methods: {
    //查询
    getList(id) {
      proPayNodeList(1, id).then((response) => {
        this.tableData = response.data;
        this.loading = false;
      });

      proTickList(1, id).then((response) => {
        this.tableData2 = response.data;
        this.loading2 = false;
      });

      proPayRectList(1, id).then((response) => {
    ...
    //编辑
    handleEdit(row) {
      this.$router.push({ path: '/production-d/incomeNodeEdit', query: { id: row.id } });
    },
