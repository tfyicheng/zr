<template class="app-container">
  <div class="main">
    ...
    <el-dialog :visible.sync="dialogTableVisible" width="400px">
      <DownForm v-show="this.ChooseOne == 'downForm'" :type="2" ref="downForm" />
    </el-dialog>
  </div>
</template>

<script>
import { projectSelfList, projectDelete, projectTermination, projExport } from '@/api/data/project';
...
export default {
  ...
  methods: {
    ...
    getList(queryParam) {
      ...
      projectSelfList(newqp ? newqp : this.queryParams).then((response) => {
