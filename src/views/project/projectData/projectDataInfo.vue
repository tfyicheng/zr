<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['项目管理', '项目资料归档管理', '项目资料归档列表', '资料归档信息']" />
        <div class="main">
          <div class="p0">
        ...
        <div class="p3">
          ...
          <el-button type="primary" v-show="flag == '1'" @click="edit">编辑</el-button>
          <el-button type="primary" v-show="flag == '1'" @click="save">完成归档</el-button>
        </div>
...
import { prjDataInfo, prjDataComplete } from '@/api/data/project';
export default {
  ...
  methods: {
    ...
    getInfo() {
      if (this.$route.query.id) {
        ...
        prjDataInfo(this.$route.query.id).then((response) => {
          this.form = response.data;
          this.tableData = response.data.prjDataList;
    ...
    edit() {
      this.$store.dispatch('tagsView/delView', this.$route);
      this.$router.push({ path: '/project-d/projectDataEdit', query: { id: this.form.id } });
    },
