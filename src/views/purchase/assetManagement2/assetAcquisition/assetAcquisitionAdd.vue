<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资产采购管理', '消耗品领用管理', '消耗品领用列表', '消耗品领用登记']" />
        <div class="main">
          <div class="p0">
...
import { stockUseC1Add, stockUseAdd, storeList } from '@/api/data/asset';
import { purchaseContTrades, purchaseContInfo } from '@/api/data/contract';

export default {
  name: 'AssetAcquisitionAdd2', //资产领用登记
  ...
  methods: {
    ...
    getMat(data) {
      ...
      if (data && data.length > 0) {
        ...
        //this.data.materials.find((item) => item.uid === this.uid)=
