<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资产采购管理', '消耗品领用管理', '消耗品领用列表']" />
        <div class="main">
          <div class="p1">
            <!-- <div class="p1item">
              <el-input
            ...
            <div class="p1item">
              <el-select v-model="queryParams.deptId" placeholder="领用部门" clearable>
                <el-option
                  v-for="item in depts"
                  :key="item.deptId"
                  :label="item.deptName"
          ...
          <div class="p2">
            <el-button v-hasPermi="['property:stock1:use']" type="primary" @click="addC"
              >添加</el-button
            >
            ...
            <el-button
              v-hasPermi="['property:stock:export1']"
              type="warning"
              @click="exportList"
          ...
          <div class="p3">
            ...
            >
              ...
              <el-table-column prop="applyDept" label="领用部门"> </el-table-column>
              <el-table-column prop="applyUser" label="领用人"> </el-table-column>
              <el-table-column prop="useAddr" label="领用地址"> </el-table-column>
              <el-table-column prop="inventoryDate" label="领用时间"> </el-table-column>
              <el-table-column prop="storeName" label="领用仓库"> </el-table-column>
              ...
              <el-table-column prop="applyDept" label="现保管部门"> </el-table-column>
              <el-table-column prop="inventoryDate" label="领用时间"> </el-table-column>
              ...
              <el-table-column fixed="right" label="操作" :show-overflow-tooltip="false">
                <template slot-scope="scope">
                  <el-button
                    v-hasPermi="['property:stock1:use:info']"
                  ...
                  <el-button
                    v-hasPermi="['property:stock1:use:edit']"
                    type="text"
                    size="small"
...
export default {
  name: 'AssetAcquisitionCheck2', //查看资产领用
  ...
  methods: {
    ...
    getList() {
      ...
      stockUseC1List(this.queryParams).then((response) => {
    ...
    //导出列表
    exportList() {
      assetReqExportList(this.queryParams);
    },
    ...
    async handleWork(row) {
      ...
      let data = {
        ...
        remark: '', //备注
        type: 1, //0入库审批1领用审批2出库审批
      };
      this.$modal.loading('正在提交，请稍候...');
      stockApproveBack(data)
        .then((res) => {
    ...
    handleCheck(row) {
      console.log(row);
      this.$router.push({
        path: '/purchase-d/assetAcquisitionInfo2',
    ...
    //编辑
    handleEdit(row) {
      this.$router.push({ path: '/purchase-d/assetAcquisitionEdit2', query: { id: row.id } });
    },

    //添加
    addC() {
      this.$router.push({ path: '/purchase-d/assetAcquisitionAdd2' });
    },
  },
