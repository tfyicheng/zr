<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资产采购管理', '消耗品入库管理', '消耗品入库列表', '编辑消耗品入库']" />
        <div class="main">
          <div class="p0">
