<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资产采购管理', '消耗品入库管理', '消耗品入库列表', '消耗品入库详情']" />
        <div class="main">
          <div class="mainl">
            <div class="p1">
              <div class="p1item">
...
<script>
import { stockInC1Info, stockInfo, stockApproveBack } from '@/api/data/asset';

export default {
  name: 'AssetInInfo2', //资产入库信息
  ...
  methods: {
    ...
    getInfo() {
      if (this.$route.query.id) {
        stockInC1Info(this.$route.query.id).then((response) => {
