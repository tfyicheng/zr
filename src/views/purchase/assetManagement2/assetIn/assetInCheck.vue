<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资产采购管理', '消耗品入库管理', '消耗品入库列表']" />
        <div class="main">
          <div class="p1">
            <!-- <div class="p1item">
          ...
          <div class="p2">
            <el-button v-hasPermi="['property:stock1:in']" type="primary" @click="addC"
              >添加</el-button
            >
          ...
          <div class="p3">
            ...
            >
              ...
              <el-table-column fixed="right" label="操作" :show-overflow-tooltip="false">
                <template slot-scope="scope">
                  <el-button
                    v-hasPermi="['property:stock1:in:info']"
                  ...
                  <el-button
                    v-hasPermi="['property:stock1:in:edit']"
                    type="text"
                    size="small"
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      stockInC1List(this.queryParams).then((response) => {
    ...
    //编辑
    handleEdit(row) {
      this.$router.push({ path: '/purchase-d/assetInEdit2', query: { id: row.id } });
    },
