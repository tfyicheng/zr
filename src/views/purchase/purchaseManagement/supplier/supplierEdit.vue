<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资产采购管理', '供应商管理', '供应商列表', '编辑供应商']" />
        <div class="main">
          <div class="p0">
        ...
        <div class="main2">
          ...
          <div class="m2main" v-show="nodeShow">
            <div class="m2mt" v-show="form.contactsList && form.contactsList.length > 0">
...
<script>
import { supplierEdit, supplierContactsInfo, supplierContacts } from '@/api/data/asset';

export default {
  name: 'SupplierEdit', //编辑供应商
  data() {
    return {
      form: {
        contactsList: [],
        ...
        supplierContactsInfo(this.$route.query.id).then((res) => {
          if (res.data) {
            ...
            supplierContacts(this.$route.query.id).then((res) => {
              if (res.data) {
                // this.form.contactsList = { ...this.form.contactsList, ...res.data };
                //   this.form.contactsList = { ...res.data };
                this.form.contactsList = res.data;
              }
            });
          }
