<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop
          :val="['资产采购管理', '固定资产入库管理', '固定资产入库列表', '固定资产入库登记']"
        />
        <div class="main">
          <div class="p0">
              ...
              <div class="m2mt">
                <div class="m2mb">
                  <el-form-item label="" prop="assetNumber">
                    <el-input v-model="c.assetNumber" placeholder="请输入" clearable></el-input>
                  </el-form-item>
                </div>
                ...
                <div class="m2mb">
                  <el-form-item label="">
                    <el-select v-model="c.propertyType" placeholder="请选择">
                      <el-option
                ...
                <div class="m2mb">
                  <el-form-item label="">
                    <el-input v-model="c.voucherTime" placeholder="请输入" clearable></el-input>
                  </el-form-item>
                </div>
...
export default {
  ...
  methods: {
    ...
    //获取采购合同下的清单信息 接口作废 改成查询合同详情用type字段区别资产类型
    getAcontList(id) {
      if (id) {
    ...
    getMat(data) {
      this.dialogTableVisible = false;
      if (data && data.length > 0) {
        var nd = this.form.materials.find((item) => item.uid === this.uid);
        if (nd) {
          nd.manufacturer = data[0].manufacturer;
