    ...
    <div class="appi">
      <div class="appc">
        ...
        <div class="p3">
          ...
          <!-- <el-button
            v-show="approves.findIndex((c) => c.status == 1) != -1"
            @click="handleWork(1)"
            >通过</el-button
          >
          <el-button
            v-show="approves.findIndex((c) => c.status == 2) != -1"
            @click="handleWork(2)"
            >驳回</el-button
          > -->
...
export default {
  name: 'ReceiveHandle', //处理领用审批
  dicts: ['project_scale', 'store_out_type', 'unit_of_measurement'],
  data() {
    return {
      maxtbheigth: '300',
      paymentShow: true,
