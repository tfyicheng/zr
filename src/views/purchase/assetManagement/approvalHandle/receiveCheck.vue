...
import { stockUseAList, storeList, stockApproveBack } from '@/api/data/asset';
export default {
  name: 'ReceiveCheck', //查看领用审批
  ...
  methods: {
    ...
    getList(queryParam) {
      ...
      stockUseAList(this.queryParams).then((response) => {
