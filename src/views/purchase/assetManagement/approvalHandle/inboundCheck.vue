  ...
  <div class="main">
    ...
    <div class="p3">
      ...
      >
        ...
        <el-table-column prop="storeUser" label="仓库管理员"> </el-table-column>
        ...
        <el-table-column fixed="right" width="200" label="操作" :show-overflow-tooltip="false">
          <template slot-scope="scope">
            <el-button
...
export default {
  ...
  methods: {
    ...
    getList(queryParam) {
      ...
      stockInAList(this.queryParams).then((response) => {
