<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop
          :val="['资产采购管理', '固定资产领用管理', '固定资产领用列表', '固定资产领用登记']"
        />
        <div class="main">
          <div class="p0">
...
import { stockUseC0Add, stockUseAdd, storeList } from '@/api/data/asset';
import { purchaseContTrades, purchaseContInfo } from '@/api/data/contract';

export default {
  name: 'AssetAcquisitionAdd', //资产领用登记
