<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop
          :val="['资产采购管理', '固定资产领用管理', '固定资产领用列表', '编辑固定资产领用']"
        />
        <div class="main">
          <div class="p0">
...
import { stockUseC0Edit, stockUseC0Info, stockUseAdd, storeList } from '@/api/data/asset';
import { purchaseContTrades } from '@/api/data/contract';

export default {
  name: 'AssetAcquisitionEdit', //编辑资产领用
