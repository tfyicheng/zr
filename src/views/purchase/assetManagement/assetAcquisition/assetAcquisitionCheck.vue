<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资产采购管理', '固定资产领用管理', '固定资产领用列表']" />
        <div class="main">
          <div class="p1">
            <!-- <div class="p1item">
              <el-input
          ...
          <div class="p2">
            <el-button v-hasPermi="['property:stock0:use']" type="primary" @click="addC"
              >添加</el-button
            >
          ...
          <div class="p3">
            ...
            >
              ...
              <el-table-column fixed="right" label="操作" :show-overflow-tooltip="false">
                <template slot-scope="scope">
                  <el-button
                    v-hasPermi="['property:stock0:use:info']"
                  ...
                  <el-button
                    type="text"
                    size="small"
                    v-hasPermi="['property:stock0:use:edit']"
...
export default {
  name: 'AssetAcquisitionCheck', //查看资产领用
  ...
  methods: {
    ...
    getList() {
      ...
      stockUseC0List(this.queryParams).then((response) => {
    ...
    handleCheck(row) {
      console.log(row);
      this.$router.push({
        path: '/purchase-d/assetAcquisitionInfo',
