      ...
      <div class="appc">
        ...
        <div class="main">
          <div class="p1">
            ...
            <div class="p1item">
              <el-button
                v-hasPermi="['property:stock0:export']"
                type="warning"
                @click="exportList"
              ...
              <el-button type="warning" v-hasPermi="['property:stock0:export']" @click="importList"
                >导入</el-button
              >

              <el-button
                v-hasPermi="['property:stock0:exportImportTemplate']"
                style="width: auto; background-color: #46a6ff"
                type="primary"
                @click="downTemplate"
                >下载导入模版</el-button
              >
          ...
          <div class="p3">
            ...
            >
              ...
              <el-table-column fixed="right" label="操作" width="100">
                <template slot-scope="scope">
                  <el-button
                    v-hasPermi="['property:stock0:stock:info']"
...
export default {
  ...
  methods: {
    ...
    //导出列表
    exportList() {
      assetExportList1(this.queryParams);
    },
