<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资产采购管理', '资产报废管理', '资产报废列表', '编辑资产报废']" />
        <div class="main">
          <div class="p0">
        ...
        <div class="main2">
          ...
          <div class="m2main" v-show="paymentShow">
            ...
            <!-- <div>
              <el-button type="primary" @click="addPayments">添加报废</el-button>
            </div> -->
          </div>
        </div>
...
import { stockOutC0Edit, stockOutC0Info, stockUseAdd, storeList } from '@/api/data/asset';
import { purchaseContTrades } from '@/api/data/contract';

export default {
  name: 'AssetOutEdit', //编辑报废登记
  ...
  methods: {
    ...
    getInfo() {
      if (this.$route.query.id) {
        ...
        stockOutC0Info(this.$route.query.id).then((response) => {
          if (response.data) {
