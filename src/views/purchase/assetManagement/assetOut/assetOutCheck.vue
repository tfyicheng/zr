<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资产采购管理', '资产报废管理', '资产报废列表']" />
        <div class="main">
          <div class="p1">
            <!-- <div class="p1item">
              <el-input
            ...
            <!-- 
            <div class="p1item">
              <el-select v-model="queryParams.applyDeptId" placeholder="部门" clearable>
                <el-option
                  v-for="item in depts"
                  :key="item.deptId"
                  :label="item.deptName"
            ...
            <!-- <div class="p1item">
              <el-select v-model="queryParams.outType" placeholder="出库类型" clearable>
                <el-option
            ...
            <div class="p1item">
              <el-select v-model="queryParams.deptId" placeholder="报废部门" clearable>
                <el-option
                  v-for="item in depts"
                  :key="item.deptId"
                  :label="item.deptName"
          ...
          <div class="p2">
            <el-button v-hasPermi="['property:stock0:out']" type="primary" @click="addC"
              >添加</el-button
            >
            ...
            <el-button
              v-hasPermi="['property:stock:export2']"
              type="warning"
              @click="exportList"
          ...
          <div class="p3">
            ...
            >
              ...
              <!-- <el-table-column prop="applyDept" label="部门名称"> </el-table-column> -->
              <!-- <el-table-column prop="applyUser" label="出库人"> </el-table-column> -->
              <!-- <el-table-column prop="inventoryDate" label="出库时间"> </el-table-column> -->
              <!-- <el-table-column prop="storeName" label="出库仓库"> </el-table-column> -->
              ...
              <el-table-column prop="num" label="报废数量"> </el-table-column>
              <el-table-column prop="applyDept" label="报废部门"> </el-table-column>
              <el-table-column prop="inventoryDate" label="报废时间"> </el-table-column>
              <!-- <el-table-column prop="applyUser" label="报废人"> </el-table-column> -->

              <el-table-column fixed="right" label="操作" :show-overflow-tooltip="false">
                <template slot-scope="scope">
                  <el-button
                    v-hasPermi="['property:stock0:out:info']"
...
export default {
  name: 'AssetOutCheck', //查看资产报废
  dicts: ['approval_status', 'out_type', 'store_out_type', 'property_type2'],
  data() {
    return {
      depts: [], //部门项
      stores: [], //仓库项
  ...
  methods: {
    ...
    getList() {
      ...
      stockOutC0List(this.queryParams).then((response) => {
    ...
    //导出列表
    exportList() {
      assetOutExportList(this.queryParams);
    },
    ...
    //添加
    addC() {
      this.$router.push({ path: '/purchase-d/assetOutAdd' });
    },
  },
