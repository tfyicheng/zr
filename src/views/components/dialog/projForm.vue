      ...
      <div class="main">
        <el-form ref="loginForm">
          <div class="p1">
            <div class="p1item">
              <span>项 目 类 型</span>
              <el-select v-model="queryParams.prjTypes" multiple placeholder="点击选择">
                <el-option
            ...
            <div class="p1item">
              <span>项目合同</span>
              <el-select v-model="queryParams.prjCont" placeholder="点击选择">
                <el-option
                  v-for="item in prjConts"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                >
            ...
            <div class="p1item">
              <span>中标通知</span>
              <el-select v-model="queryParams.needBid" placeholder="点击选择">
                <el-option
                  v-for="item in needBids"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                >
            ...
            <div class="p1item">
              <span>批复</span>
              <el-select v-model="queryParams.approvals" multiple placeholder="点击选择">
                <el-option
                  v-for="item in approvalss"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                >
            ...
            <div class="p1item">
              <span>验收</span>
              <el-select v-model="queryParams.checks" multiple placeholder="点击选择">
                <el-option
                  v-for="item in checkss"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                >
