  ...
  <div class="appo">
    <div class="appi">
      <div class="appc">
        ...
        <div class="main">
          <div class="p1">
            <div class="p1item" v-hasPermi="['system:post:add']">
              <div>
            ...
            <div class="p1item">
              <el-input v-model="queryParams.phonenumber" placeholder="电话号码" clearable></el-input>
            </div>
          ...
          <div class="p2">
            <div class="p2choose">
              ...
              <span class="p2chooses">
                <span v-for="c in chooseItemss" :key="c.index">{{ c.deptName }}</span>
              </span>
...
export default {
  name: 'DeptList', //选择组织部门列表
  //dicts: ['certificate_category', 'user_job_status'],
  props: {
  ...
  data() {
    return {
      ...
      tableData: [
        {
          createBy: 'admin',
          createTime: '2023-11-16 10:19:25',
          updateBy: null,
          updateTime: null,
          remark: 'gdg gdgdg',
          startTime: null,
  ...
  methods: {
      ...
      listDept(this.queryParams).then((response) => {
        ...
        response.data.forEach((item, index) => {
          ...
          for (let i = 0; i < resdata2.length; i++) {
            if (resdata2[i].deptId == item.deptId) {
              // this.$nextTick(() => {
    ...
    addItem() {
      this.$router.push({ path: '/person/dept' });
      this.goback();
    },
