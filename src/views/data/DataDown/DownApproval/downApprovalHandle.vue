<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资料管理', '下载审批', '下载审批列表', '审批处理']" />
        <div class="main">
          <div class="p1">
            <div class="p1item">
              <span>申 请 部 门</span>
            ...
            <div class="p1item">
              <span>事 由</span>
              <span>
                <dict-tag :flag="false" :options="dict.type.reason_type" :value="form.reason" />
              </span>
            </div>
...
<script>
import { ApprovalInfo, fileApprovalApply } from '@/api/data/file';
export default {
  name: 'DownApprovalInfo', //下载审批详情
