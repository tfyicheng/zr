        ...
        <div class="main">
          ...
          <div class="p2">
            ...
            <el-button
              ...
              >导出</el-button
            >
            <!-- <el-button type="warning" v-hasPermi="['contract:project:import']" @click="importList"
              >导入</el-button
            > -->
            <!-- <el-button
...
export default {
  ...
  methods: {
    ...
    //任务单
    handleSheet(row) {
      this.$router.push({ path: '/data-d/taskSheetP', query: { id: row.id } });
    },
  },
