  ...
  <div class="appo">
    <div class="appi">
      <div class="appc">
        ...
        <NavTop :val="['资料管理', '合同管理', '项目合同列表', '添加项目合同']" />
            ...
            <div class="p0">
              <el-form :model="form" :inline="true" ref="form3" :rules="ruleData">
                <el-form-item label="项 目 区 域">
                  <AddrCascader :data.sync="form.prjArea2" />
                </el-form-item>
...
import { projectContAdd } from '@/api/data/contract';
import { custInfo } from '@/api/data/customer';
export default {
  name: 'ProjectContractAdd', //添加项目合同
  dicts: [
    'cont_type',
    'project_scale',
    'project_type',
  ...
  data() {
    return {
      ...
      ruleData: {
        ...
        prjArea2: [{ required: true, message: '区域不能为空', trigger: ['blur', 'change'] }],
  ...
  methods: {
    ...
    checkContUp() {
      ...
      //   console.log(index + 1, this.$refs[c.uid][0].fileList.length, this.$refs[c.uid][0].fileList);
      // }
