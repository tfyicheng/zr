      ...
      <div class="appc">
        ...
        <div class="main">
          <div class="p1">
            ...
            <!-- <div class="p1item">
              <el-input v-model="queryParams.templateName" placeholder="合同名称" clearable></el-input>
            </div> -->
            <!-- <div class="p1item">
              <el-input
          ...
          <div class="p2">
            <el-button v-hasPermi="['contract:template:add']" type="primary" @click="addC"
              >添加</el-button
            >
            <!-- <el-button
          ...
          <div class="p3">
            ...
            >
              ...
              <el-table-column prop="templateName" label="合同范本名称"> </el-table-column>
              <el-table-column prop="templateDesc" label="合同范本描述"> </el-table-column>
              ...
              <el-table-column fixed="right" label="操作" width="250">
                <template slot-scope="scope">
                  <el-button
                    v-hasPermi="['contract:template:list']"
          ...
          <BeforeDown
            ref="BeforeDown"
            :downSourceName="query.templateName"
            :downSourceId="query.id"
            :type="9"
          />
        </div>
      </div>
...
import { templateList, templateDelete } from '@/api/data/contract';
export default {
  name: 'ContractTemplateIndex', //合同范本
  ...
  data() {
    return {
      ...
      query: { templateName: null, id: null },
  ...
  methods: {
    ...
    getList() {
      ...
      templateList(this.queryParams).then((response) => {
    ...
    //下载/导出
    Output(row) {
      this.query.templateName = row.templateName;
    ...
    handleCheck(row) {
      console.log(row);
      this.$router.push({ path: '/data-d/templatetInfo', query: { id: row.id, data: row } });
    },

    //编辑
    handleEdit(row) {
      this.$router.push({ path: '/data-d/templatetEdit', query: { id: row.id, data: row } });
    },

    //添加
    addC() {
      this.$router.push({ path: '/data-d/templatetAdd' });
    },
  },
