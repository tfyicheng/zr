<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <!-- <div class="top">证书信息</div> -->
        <NavTop :val="['资料管理', '证书管理', '证书列表']" />
        ...
        <div class="main">
          ...
          <div class="p2">
            <el-button type="primary" @click="addC" v-hasPermi="['certificate:cert0:add']"
              >添加</el-button
            >
          ...
          <div class="p3">
            ...
            >
                ...
                <template slot-scope="scope">
                  ...
                  >
                    ...
                    <div slot="reference" class="name-wrapper">
                      <el-link class="collink" type="primary" :underline="false" size="medium">
                        {{
              ...
              >
                <template slot-scope="scope">
                  <el-button
                    v-hasPermi="['certificate:cert0:query']"
                  ...
                  <el-button
                    type="text"
                    size="small"
                    v-hasPermi="['certificate:cert0:edit']"
                    @click="handleEdit(scope.row)"
                    style="font-size: 14px"
                    >编辑</el-button
                  >
                  <el-button
                    v-hasPermi="['file:down:cert0']"
          ...
          <!-- v-disable-right-click   oncontextmenu="return false;" -->
...
<script>
//import CertCascader from '@/components/Analysis/certCascader';
import { certList0, certDel0 } from '@/api/data/certificate';
import { certDown } from '@/api/data/file';
export default {
  name: 'CertificatesCheck', //证书信息查看检索
  ...
  methods: {
    ...
    getList() {
      ...
      this.$forceUpdate();
      console.log(this.queryParams, this.queryParams.certParentType);
    ...
    //切换大类联动中类
    certPChange() {
      console.log(this.dict.type.certificate_category);
      this.certChildTypes =
