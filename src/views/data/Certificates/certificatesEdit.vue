  ...
  <div class="appo">
    <div class="appi">
      <div class="appc">
        ...
        <NavTop :val="['资料管理', '证书管理', '证书列表', '编辑证书']" />
        <div class="main">
          <div class="p0">
        ...
        <el-dialog :visible.sync="dialogTableVisible">
          <!-- <PersonList ref="pList" :value="form.foreignCert" /> -->
          <DeptList ref="dList" :value="form.foreignCert" />
        </el-dialog>
      </div>
    </div>
  </div>
