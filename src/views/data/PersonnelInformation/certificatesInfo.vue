<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资料管理', '人员证书管理', '人员证书列表', '查看人员证书']" />
        <div class="main">
          <!-- <div class="p1item">
              <span>证 书 类 型</span>
              <span>
          ...
          <div class="p1">
            ...
            <div class="p1item">
              ...
              <span>
                <dict-tag :options="dict.type.person_cert" :value="form.certParentType" />
              </span>
            </div>
            <div class="p1item">
              <span>证 书 中 类</span>
            ...
            <div class="p1item">
              <span>专 业</span>
              <span>
                <InputTip :width="inputTipWidth" :text="form.major"></InputTip>
              </span>
            </div>
            <div class="p1item">
              <span>发 证 时 间</span>
            ...
            <div class="p1item">
              <span>通 过 时 间</span>
              <span>
                <InputTip :width="inputTipWidth" :text="form.throughDate"></InputTip>
              </span>
            </div>
            <div class="p1item">
              <span>有 效 时 间</span>
        ...
        <ApplyDown ref="ApplyDown" :downSourceId="form.id" :type="13" @ok="applyHandle" />
...
import { certInfo1 } from '@/api/data/certificate';
export default {
  name: 'PCertificatesInfo', //证书信息
  dicts: ['person_cert', 'cert_type', 'cert_years'],
  ...
  methods: {
    ...
    exportApply() {
      try {
        this.$refs.ApplyDown.downSourceName = this.dict.type.person_cert.find(
          (v) => v.value == String(this.form.certParentType),
        ).raw.dictLabel;
      } catch (error) {
        this.$refs.ApplyDown.downSourceName = '';
      }
