    ...
    <div class="appi">
      <div class="appc">
        ...
        <div class="main">
          ...
          <el-dialog class="iframe" :visible.sync="dialogTableVisible" v-el-drag-dialog>
            <iframe id="iframe" width="100%" height="100%" :src="fileview"></iframe>
          </el-dialog>
...
export default {
  name: 'PCertificatesCheck', //个人证书信息查看检索
  ...
  methods: {
    ...
    preview(row) {
      ...
      setTimeout(() => {
        ...
        //this.fileview = 'https://blog.csdn.net/2401_84204034/article/details/137738543';
    ...
    //编辑
    handleEdit(row) {
      this.$router.push({ path: '/data-d/pcertificatesEdit', query: { id: row.id } });
    },

    //添加证书
    addC() {
      this.$router.push({ path: '/data-d/pcertificatesAdd' });
    },
