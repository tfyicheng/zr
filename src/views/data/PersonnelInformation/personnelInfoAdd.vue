<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['资料管理', '人员管理', '人员列表', '添加人员']" />
        <!-- <div class="top">
        ...
        <div class="main">
          <div class="p1">
            ...
            <div class="p1item">
              <span><i style="color: red; visibility: hidden">*</i>学 历</span>
              <el-select v-model="form.certType" placeholder="点击选择">
                <el-option
            ...
            <div class="p1item">
              <span><i style="color: red; visibility: hidden">*</i>工 作 状 态</span>
            ...
            <div class="p1item">
              <span><i style="color: red; visibility: hidden">*</i>婚 姻 状 况</span>
            ...
            <div class="p1item">
              <span><i style="color: red">*</i>毕 业 院 校</span>
              <el-input
            ...
            <div class="p1item">
              <span><i style="color: red">*</i>现 住 址 </span>
              <el-input
...
<script>
import { personAdd } from '@/api/data/person';
