    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="任务组名" align="center" prop="jobGroup">
        <template slot-scope="scope">
          <dict-tag :flag="false" :options="dict.type.sys_job_group" :value="scope.row.jobGroup" />
        </template>
      </el-table-column>
      <el-table-column
        label="调用目标字符串"
            ...
            <el-form-item prop="invokeTarget">
              <span slot="label">
                ...
                <el-tooltip placement="top">
                  <div slot="content">
                    Bean调用示例：task.params('guangwei')
                    <br />Class类调用示例：com.guangwei.quartz.task.Task.params('guangwei')
