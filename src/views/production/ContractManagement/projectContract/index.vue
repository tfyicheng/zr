  ...
  <div class="appo">
    <div class="appi">
      ...
      <!-- <div class="top" style="margin-bottom: 15px">
        ...
        <span> > </span>
        <span style="cursor: pointer" @click="commonFun.goTo('项目合同统计')">项目合同管理</span>
      </div> -->

      <div class="part1" style="height: 200px"><TopInfoView :type="6" ref="TopInfoView" /></div>
      ...
      <div class="part6">
        <div class="part6item" style="height: 370px"><TableAll :type="20" /></div>
        <div class="part6item" style="height: 370px"><BarChart :type="0" /></div>
      </div>
      ...
      <!-- <div class="part4">
        ...
        <div class="part4item" style="height: 200px">
          <TopInfoView :type="6" ref="TopInfoView" />
        </div>
      </div>
      <div class="part4">
        <div class="part4item" style="height: 370px"><BarChart :type="0" /></div>
        <div class="part4item" style="height: 370px"><LineChart :type="1" /></div>
      </div>
      <div class="part2">
        <div class="part2item" style="height: 370px"><PieChart :type="0" /></div>
        <div class="part2item" style="height: 370px"><PieChart :type="1" /></div>
...
export default {
  name: 'ProjectContractIndex', //项目合同首页概览
  components: {
    TopInfoView,
    MenuNav,
    BarChart,
