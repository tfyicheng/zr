      ...
      <div class="appc">
        ...
        <div class="main">
          <div class="p1">
            ...
            <div class="p1item">
              <el-input v-model="queryParams.principal" placeholder="委托人" clearable></el-input>
            </div>

            <div class="p1item">
              <AddrCascader :data.sync="queryParams.bidArea" ref="AddrCascader" />
            </div>
          ...
          <div class="p2">
            <el-button v-hasPermi="['produce:bid:add']" type="primary" @click="addC"
              >添加</el-button
            >
            <el-button
              v-hasPermi="['produce:bid:export']"
              type="warning"
              @click="exportList"
          ...
          <div class="p3">
            ...
            >
              ...
              <el-table-column prop="" label="投标区域">
                <template slot-scope="scope">
                  {{
                    commonFun.coverRegin(
                      scope.row.bidProvince,
                      scope.row.bidCity,
                      scope.row.bidRegion,
                      '',
                    )
              ...
              <el-table-column prop="totalInvestment" label="总投资(万元)"> </el-table-column>
              <el-table-column prop="principal" label="委托人"> </el-table-column>
              <el-table-column prop="bidTime" label="投标时间"> </el-table-column>
              <el-table-column fixed="right" label="操作" width="150">
                <template slot-scope="scope">
                  <el-button
                    v-hasPermi="['produce:bid:query']"
...
<script>
import { bidList, bidDelete, bidExportList } from '@/api/data/produce';
export default {
  name: 'BidManagementCheck', //查看投标信息
  data() {
    return {
      loading: true, // 遮罩层
      chooseItems: [], // 选中项
  ...
  methods: {
    ...
    //导出列表
    exportList() {
      bidExportList(this.queryParams);
    },
