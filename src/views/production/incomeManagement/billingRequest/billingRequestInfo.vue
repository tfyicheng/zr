<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['生产管理', '开票记录管理', '开票记录列表', '开票记录详情']" />
        ...
        <div class="main">
          <div class="p0">
            <el-form :model="form" :inline="true" ref="form" class="info" @submit.native.prevent>
              ...
              <el-form-item label="票 据 类 型" prop="billType">
                <div class="info">
                  <dict-tag :options="dict.type.invoice_type" :value="form.billType" />
                </div>
              </el-form-item>

              <el-form-item label="发 票 编 号" prop="invoiceNumber">
                <div class="info">
                  <InputTip :width="inputTipWidth" :text="form.invoiceNumber"></InputTip>
                </div>
              </el-form-item>

              <el-form-item label="开 票 日 期" prop="invoicingDate">
                <div class="info">
              ...
              <el-form-item label="开 票 附 件" class="file">
        ...
        <ApplyDown ref="ApplyDown" :type="14" />
        <BeforeDown ref="BeforeDown" :type="14" />
      </div>
    </div>
  </div>
</template>
...
<script>
import { invoiceInfo } from '@/api/data/produce';

export default {
  name: 'BillingRequestInfo', // 开票记录详情
  dicts: ['invoice_type'],
  data() {
    return {
      maxtbheigth: '300',
  ...
  methods: {
    ...
    getInfo() {
      if (this.$route.query.id) {
        invoiceInfo(this.$route.query.id).then((response) => {
    ...
    exportApply() {
      ...
      this.$refs.ApplyDown.downSourceName = '开票附件';
