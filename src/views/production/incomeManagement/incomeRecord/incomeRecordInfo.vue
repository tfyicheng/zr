<template class="app-container">
  <div class="appo">
    <div class="appi">
      <div class="appc">
        <NavTop :val="['生产管理', '收款记录管理', '收款记录列表', '收款记录详情']" />
          ...
          <div class="p0">
            <el-form :model="form" :inline="true" class="info" @submit.native.prevent>
              ...
              <el-form-item label="收 款 类 型">
                <div class="info">
                  <dict-tag
                    :options="dict.type.payment_business1"
        ...
        <ApplyDown ref="ApplyDown" :type="16" />
        <BeforeDown ref="BeforeDown" :type="16" />
      </div>
    </div>
  </div>
</template>
...
<script>
import { receiptsInfo } from '@/api/data/produce';

export default {
  name: 'IncomeRecordInfo', //收款记录信息
  ...
  methods: {
    ...
    exportApply() {
      ...
      this.$refs.ApplyDown.downSourceName = '收款附件';
