    ...
    <div class="appi">
      <div class="appc">
        ...
        <div class="main">
          ...
          <div class="p2">
            <el-button v-hasPermi="['produce:invoice1:add']" type="primary" @click="addC"
              >添加</el-button
            >
            ...
            <el-button type="warning" v-hasPermi="['produce:invoice1:import']" @click="importList"
              >导入</el-button
            >

            <el-button
              v-hasPermi="['produce:invoice1:importTemplate']"
              style="width: auto"
              type="primary"
              @click="downTemplate"
              >下载导入模版</el-button
            ...
            <el-button
              v-hasPermi="['produce:invoice1:remove']"
              type="danger"
              @click="deleteT"
          ...
          <div class="p3">
            ...
            >
              ...
              <el-table-column prop="invoiceNumber" label="收票编号"> </el-table-column>
...
<script>
import { ticketCList, ticketCDelete, importTemplate1 } from '@/api/data/produce';
export default {
  name: 'ReceiptRecordCheck', //查看收票记录
  ...
  methods: {
    ...
    getList() {
      ticketCList(this.queryParams).then((response) => {
    ...
    async deleteT(row) {
      ...
      ticketCDelete(params.join(',')).then((res) => {
        if (res.code == 200) {
